              ...
              <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
                ...
                <div className="flex flex-wrap">
                  <div className="w-full md:w-auto py-1 md:py-0">
                    <Link to={"/register"}
                      className="inline-block py-5 px-7 w-full text-base md:text-lg leading-4 text-coolGray-800 font-medium text-center bg-white hover:bg-blue-100 focus:ring-2 focus:ring-coolGray-200 focus:ring-opacity-50 border border-coolGray-200 rounded-md shadow-sm"
                    >
                      Sign Up
                    </Link>
                  </div>
