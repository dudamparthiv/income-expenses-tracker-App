            ...
            {accounts?.length <= 0 ? (
              <>
                ...
                <a
                  ...
                  className="px-6 py-3 text-lg font-medium text-white bg-indigo-600 rounded-full hover:bg-indigo-700"
                >
                  Create Account
                </a>
              </>
              ...
              <>
                <div className="max-w-4xl mx-auto mb-12 text-center">
                  ...
                  <Link
                    ...
                    className="inline-flex m-8 items-center rounded-full border border-transparent bg-gray-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    <svg
                  ...
                  return (
                    <a className="group block mb-6" href="#">
                      <div className="flex items-center justify-between flex-wrap p-10 bg-coolGray-50 group-hover:bg-coolGray-100 rounded-md shadow-md transition duration-200">
                        ...
                        <button
                          onClick={async () => {
                            await axios.delete(`${API_URL_ACC}/${acc?._id}`);
                            window.location.reload();
                          }}
                        >
                          <div className="w-full md:w-1/2 md:text-right">
                            <div className="inline-flex items-center leading-6 text-red-500 group-hover:text-red-600 font-medium transition duration-200">
